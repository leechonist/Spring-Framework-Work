...
<head>
	...
	<body>
		...
		<Form Action = "itemupdate.do" Method="post">
			<center>
				상품 이름 : <input type="text" Value = ${itemname} name = "name"><BR>
				상품 가격 : <input type="text" Value = ${itemprice} name = "price"><BR>
				상품 개수 : <input type="number" min="0" Value = ${itemcount} name = "count"><BR><BR>
