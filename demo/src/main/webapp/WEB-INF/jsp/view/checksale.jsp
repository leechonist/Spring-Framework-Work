...
<head>
	...
	<body>
		...
		<br><br><br><br>
			<Form Action = "checksale.do" Method="post">
				<Input type="Submit" Value="다음 거래" Name = "value">
				<Input type="Submit" Value="환불" Name = "value">
				<Input type="Submit" Value="이전 거래" Name = "value">
