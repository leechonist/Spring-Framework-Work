...
public class JavaConfig {
	...
	@Bean
	public AnalyzeInfoClass analyzeInfo()
	{
		return new AnalyzeInfoClass(dataSource());
	}
	@Bean
	...
	@Bean
	public SaleListControlClass saleHistoryControl()
	{
		return new SaleListControlClass();
	}
	@Bean
	public EmployeeControlClass employeeControl()
	{
		return new EmployeeControlClass();
	}
	@Bean
	public AnalyzeControlClass analyzeControl()
	{
		return new AnalyzeControlClass();
	}
}
